...
object Version {
  ...
  const val androidKtx = "1.0.1"   //https://github.com/android/android-ktx
  ...
  // kotlin
  const val kotlin = "1.3.70" // https://kotlinlang.org/
  ...
  const val rxReplayingShare = "2.1.1"  //https://github.com/JakeWharton/RxReplayingShare
  ...
  const val rxPermissions = "0.7.0"    //https://github.com/vanniktech/RxPermission
  const val rxJava2Extensions = "0.20.8"//https://github.com/akarnokd/RxJava2Extensions
  ...
  const val retrofitConverterLoganSquare =
    "1.4.1" //https://github.com/mannodermaus/retrofit-logansquare
  ...
  //lifecycle
  const val lifecycle =
    "2.0.0-rc01" //https://developer.android.com/topic/libraries/architecture/lifecycle

  //navigation
  const val navigation =
    "1.0.0-alpha07" //https://developer.android.com/topic/libraries/architecture/navigation
  ...
  const val simpleAuth = "2.1.4"  //https://github.com/jaychang0917/SimpleAuth

  // firebase
  const val firebaseCore = "16.0.1"
  const val firebaseMessaging = "17.1.0"
  const val firebaseAnalytics = "17.2.0"
  const val firebaseConfig = "19.0.0"
  ...
  //PageIndicator
  const val pageIndicator = "1.0.3" //https://github.com/romandanylyk/PageIndicatorView

  //MPAndroidChart
  const val androidChart = "3.1.0" //https://github.com/PhilJay/MPAndroidChart

  //BiometricPrompt
  const val biometricPrompt = "1.0.0-alpha04"

  //KeyboardWatcher
  const val keyboardWatcher = "2.3.0" //https://github.com/yshrsmz/KeyboardVisibilityEvent

  //PhoneNumberUtil
  const val phoneNumberUtil = "8.10.7"
...
object Deps {
  ...
  const val androidAnnotation = "androidx.annotation:annotation:${Version.annotation}"
  ...
  const val coroutines =
    "org.jetbrains.kotlinx:kotlinx-coroutines-core:${Version.coroutinesAndroid}"
  ...
  const val rxReplayingShare = "com.jakewharton.rx2:replaying-share:${Version.rxReplayingShare}"
  ...
  const val rxJava2Extensions =
    "com.github.akarnokd:rxjava2-extensions:${Version.rxJava2Extensions}"
  ...
  const val rxBindingAppCompat =
    "com.jakewharton.rxbinding3:rxbinding-appcompat:${Version.rxBinding3}"
  const val rxBindingDrawer =
    "com.jakewharton.rxbinding3:rxbinding-drawerlayout:${Version.rxBinding3}"
  const val rxBindingLeanBack =
    "com.jakewharton.rxbinding3:rxbinding-leanback:${Version.rxBinding3}"
  const val rxBindingRecyclerView =
    "com.jakewharton.rxbinding3:rxbinding-recyclerview:${Version.rxBinding3}"
  const val rxBindingSlidingPanel =
    "com.jakewharton.rxbinding3:rxbinding-slidingpanelayout:${Version.rxBinding3}"
  const val rxBindingSwipeRefresh =
    "com.jakewharton.rxbinding3:rxbinding-swiperefreshlayout:${Version.rxBinding3}"
  const val rxBindingViewPager =
    "com.jakewharton.rxbinding3:rxbinding-viewpager:${Version.rxBinding3}"
  ...
  const val rxPermissions = "com.vanniktech:rxpermission:${Version.rxPermissions}"
  const val rxBindingKotlin = "com.jakewharton.rxbinding2:rxbinding-kotlin:${Version.rxBinding}"
  const val rxBindingDesignKotlin =
    "com.jakewharton.rxbinding2:rxbinding-design-kotlin:${Version.rxBinding}"
  const val rxBindingAppCompatV4Kotlin =
    "com.jakewharton.rxbinding2:rxbinding-support-v4-kotlin:${Version.rxBinding}"
  const val rxBindingAppCompatV7Kotlin =
    "com.jakewharton.rxbinding2:rxbinding-appcompat-v7:${Version.rxBinding}"
  ...
  const val navigationFragment =
    "android.arch.navigation:navigation-fragment-ktx:${Version.navigation}"
  ...
  //Gif
  const val giphy = "com.giphy.sdk:core:${Version.giphy}"
  ...
  const val leakCanaryFragment =
    "com.squareup.leakcanary:leakcanary-support-fragment:${Version.leakCanary}"
  ...
  // Facebook
  const val facebookAnalytics =
    "com.facebook.android:facebook-android-sdk:${Version.facebookAnalytics}"
  ...
  const val firebaseRemoteConfig = "com.google.firebase:firebase-config:${Version.firebaseConfig}"

  //Maps
  const val googleMaps = "com.google.android.gms:play-services-maps:${Version.googleMaps}"
  const val googleLocation =
    "com.google.android.gms:play-services-location:${Version.googleLocation}"
  const val mapBox = "com.mapbox.mapboxsdk:mapbox-android-sdk:${Version.mapBox}"
  const val mapBoxPlugin =
    "com.mapbox.mapboxsdk:mapbox-android-plugin-annotation-v8:${Version.mapBoxPlugin}"

  //Lottie
  const val lottie = "com.airbnb.android:lottie:${Version.lottie}"

  //PageIndicator
  const val pageIndicator = "com.romandanylyk:pageindicatorview:${Version.pageIndicator}"

  //MPAndroidChart
  const val androidChart = "com.github.PhilJay:MPAndroidChart:${Version.androidChart}"

  //BiometricPrompt
  const val biometricPrompt = "androidx.biometric:biometric:${Version.biometricPrompt}"

  //KeyboardWatcher
  const val keyboardWatcher =
    "net.yslibrary.keyboardvisibilityevent:keyboardvisibilityevent:${Version.keyboardWatcher}"

  //PhoneNumberUtil
  const val phoneNumberUtil = "io.michaelrocks:libphonenumber-android:${Version.phoneNumberUtil}"

  //MaterialProgressbar
  const val materialProgressbar =
    "me.zhanghai.android.materialprogressbar:library:${Version.materialProgressbar}"
